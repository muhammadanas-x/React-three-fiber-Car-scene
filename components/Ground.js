...
import { LinearDisplayP3ColorSpace, LinearEncoding, LinearMipmapLinearFilter, LinearMipmapNearestFilter, RepeatWrapping, TextureLoader } from "three";

const Ground = () => {
  // thanks to https://polyhaven.com/a/rough_plasterbrick_05 !
  const [normal, roughness] = useLoader(TextureLoader, [
    "carShow/terrain-roughness.jpg",
    "carShow/terrain-normal.jpg",
  ]);
